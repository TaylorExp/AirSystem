...
//S-登录页面内容
    ...
    $('.login').bind('click', function(){
        ...
        if($('.login_form')[0].style.display == "block")
        {
            $(window).resize(function(event) {
            cWidth = document.body.scrollWidth||document.documentElement.scrollWidth;
            cHeight = document.body.scrollHeight||document.documentElement.scrollHeight;
            document.getElementById('mask').style.height = cHeight +  'px';
            document.getElementById('mask').style.width = cWidth + 'px';
            });
        }
        mask();
        loginPos();
    ...
    $('.register_btn').bind('click', function(){
        ...
        if($('.register_form')[0].style.display == "block")
        {
            $(window).resize(function(event) {
            cWidth = document.body.scrollWidth||document.documentElement.scrollWidth;
            cHeight = document.body.scrollHeight||document.documentElement.scrollHeight;
    ...
    //创建遮罩层节点
    function mask(){
        var cWidth = document.body.scrollWidth||document.documentElement.scrollWidth;
        var cHeight = document.body.scrollHeight||document.documentElement.scrollHeight;
